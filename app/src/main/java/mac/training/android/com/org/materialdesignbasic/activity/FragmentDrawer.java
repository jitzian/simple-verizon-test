...
import mac.training.android.com.org.materialdesignbasic.imageUtil.RoundedCornersTransformation;
...
public class FragmentDrawer extends Fragment {
    ...
    @BindView(R.id.mProfileThumbnail)
    ImageView mProfileThumbnail;

    @BindView(R.id.mImageViewHeaderNavDrawer)
    ImageView mImageViewHeaderNavDrawer;
    ...
    /**
     * This method and vars are necessary to set the rounded image of profile's thumbnail
     * */
