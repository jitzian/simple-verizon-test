package mac.training.android.com.org.materialdesignbasic.listener;
...
public class SwipeRVHelper {
    ...
    public SwipeRVHelper(RecyclerView mRecyclerViewSwipe, Context context) {
        this.mRecyclerViewSwipe = mRecyclerViewSwipe;
    ...
    public void setUpItemTouchHelper() {
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                RVAdapter adapter = (RVAdapter) mRecyclerViewSwipe.getAdapter();
        ...
        mItemTouchHelper.attachToRecyclerView(mRecyclerViewSwipe);
    }
    ...
    public void setUpAnimationDecoratorHelper() {
        mRecyclerViewSwipe.addItemDecoration(new RecyclerView.ItemDecoration() {
